...
import org.pfc.socialframe.model.ServiceEvents;
...
public class EventsActivity extends Activity{
	...
	private ServiceEvents se;
	private Toast toast;
	    @Override  
	    public void onCreate(Bundle savedInstanceState) {
	        super.onCreate(savedInstanceState);  
	        setContentView(R.layout.event);
	        se = new ServiceEvents(this);
	        ...
	        pd = ProgressDialog.show(EventsActivity.this, "", "Cargando cumpleaños y eventos ...");
	        se.showEvents(EventsActivity.this);
